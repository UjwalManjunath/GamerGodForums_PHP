...
echo 'function showStuff(id) {';
echo 'document.getElementById("pcontent"+id).style.display=\'none\';';
echo 'document.getElementById("text_editbox"+id).style.display=\'block\';';
echo '}';
echo 'function showStuff_topic(id) {';
echo 'document.getElementById("tcontent"+id).style.display=\'none\';';
echo 'document.getElementById("text_edittopic"+id).style.display=\'block\';';
echo '}';
echo '</script>';
...
else
{
	...
	{	
        ...
        elseif(($_SESSION['signedin'])==true && $tempfreeze==0)
        {
            echo '</br>';
            echo '</br>';
            echo '</br>';
