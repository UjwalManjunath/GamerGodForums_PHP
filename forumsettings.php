...
<table id = "addnew" style="display:none;"  >
<tr>
...
<label>Name:</label></td>
<td ><textarea rows="3" cols="40" name="catsubject"></textarea></td></tr>
<tr>
<td valign="center"><label> Description: </label></td>
<td valign="bottom"><textarea rows="3" cols="40" name="catdescription"></textarea></td>
</tr>
<tr><td></td><td><center><input name="addforum" type="submit" id="Add" value="Add new forum"></center></td></tr>
</table>
